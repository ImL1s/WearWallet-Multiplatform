...
val viewModelModule: Module = module {
    ...
    // 地址簿 ViewModel
    viewModel { com.cbstudio.wearwallet.presentation.wallet.screens.addressbook.AddressBookViewModel() }
    ...
    // Token 列表 ViewModel
    viewModel { com.cbstudio.wearwallet.presentation.ui.token.TokenListViewModel() }

    // 新增自訂代幣 ViewModel
    viewModel { com.cbstudio.wearwallet.presentation.wallet.screens.main.token.AddCustomTokenViewModel(get(), get()) }
