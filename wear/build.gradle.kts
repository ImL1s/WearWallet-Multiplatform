...
// Public snapshot export mode (-PpublicSnapshot=true): skip Google/Firebase plugins that
// require a real wear/google-services.json. See scripts/public-export/README.md.
val isPublicSnapshot = (findProperty("publicSnapshot") as String?)?.toBoolean() ?: false
...
// Firebase plugins - not applied in publicSnapshot mode (no real google-services.json ships
// in the public export; see scripts/public-export/blacklist.txt).
if (!isPublicSnapshot) {
...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("Boolean", "PUBLIC_SNAPSHOT", isPublicSnapshot.toString())
    }
