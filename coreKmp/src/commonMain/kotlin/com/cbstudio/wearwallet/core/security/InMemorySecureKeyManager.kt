...
/**
 * In-memory SecureKeyManager for unit tests and debug emulator QA (screenshots, CI).
 * Never use in release builds on physical devices.
 */
class InMemorySecureKeyManager : SecureKeyManager, KeyVaultReconciliationCapability, KeyVaultDeletionCapability {
